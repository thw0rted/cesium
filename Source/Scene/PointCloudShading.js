...
import PointCloudEyeDomeLighting from './PointCloudEyeDomeLighting.js';
     ...
     * @param {Boolean} [options.normalShading=true] Determines whether a point cloud that contains normals is shaded by the scene's light.
     *
    ...
    function PointCloudShading(options) {
        ...
        /**
         * Determines whether a point cloud that contains normals is shaded by the scene's light.
         *
         * @type {Boolean}
         * @default true
         */
